...
class PathPlanner():
  ...
  def update(self, sm, pm, CP, VM):
    ...
    if not active or self.lane_change_timer > 10.0:
      ...
      # State transitions
      # off
      if if self.lane_change_state == LaneChangeState.off and one_blinker and not self.prev_one_blinker: # self.lane_change_state == LaneChangeState.off and one_blinker and not self.prev_one_blinker:
